...
namespace AssetBundleBrowser
{
    ...
    {
        internal AssetBundleManageTab m_Controller;
        ...
        protected override void RowGUI(RowGUIArgs args)
        {
            ...
            var enable = EditorGUI.Toggle(new Rect(args.rowRect.position, new Vector2(20f, args.rowRect.height)), bundleItem.m_Enable);
            if (enable != bundleItem.m_Enable)
            {
                bundleItem.m_Enable = enable;
                AssetBundleBrowserMain.instance.m_ManageTab.m_ManageData.m_Enables[bundleItem.displayName] = enable;
            }
            base.RowGUI(args);
            GUI.color = old;
