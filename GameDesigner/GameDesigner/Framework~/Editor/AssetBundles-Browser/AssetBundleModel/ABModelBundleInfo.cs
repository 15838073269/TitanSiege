...
namespace AssetBundleBrowser.AssetBundleModel
{
    ...
    {
        internal List<AssetInfo> m_ConcreteAssets;
        internal List<AssetInfo> m_DependentAssets;
        internal List<BundleDependencyInfo> m_BundleDependencies;
