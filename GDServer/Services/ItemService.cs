...
namespace GDServer.Services {
    ...
    public class ItemService : Singleton<ItemService> { 
        ...
        public void Init() {
            Dictionary<int, ItemDataBase> alldata = ConfigerManager.AllItemData.m_AllItemBaseDic;
            foreach (KeyValuePair<int,ItemDataBase> itemdata in alldata) {
    ...
    public class ItemBase {
        ...
        public ItemBase(int id) {
            m_Data = ConfigerManager.AllItemData.FindItemByID(id);
            XiaoguoToDic();
        }
        /// <summary>
        /// 道具效果转成字典
