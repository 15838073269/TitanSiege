...
namespace GDServer.Tools
{
    ...
    public static class MySqlHelper
    {
        ...
        //数据库连接字符串
        public static string connStr = "Database='titansiege';Data Source='127.0.0.1';Port=3306;User Id='root';Password='titansiege';charset='utf8';pooling=true";
        ...
        /// <returns></returns>
        public static bool Init(string dbName, string ip = "127.0.0.1", string port = "3306", string userName = "root", string pwd = "")
        {
        ...
        public static int ExecuteNonQuery(string cmdText)
        {
            ...
            {
                Debuger.LogError(cmdText + " 错误:" + ex);
            }
            return -1;
        }
        ...
        public static int Insert(string tableName, params ColumnData[] datas)
        {
            ...
            foreach (var item in datas)
            {
                if (item.value == null)
                {
                    Debuger.LogError($"{item.name}:参数值不能为null");
                    return -1;
                }
