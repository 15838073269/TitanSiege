...
namespace Binding
{
    public readonly struct TitansiegeCharactersDataBind : ISerialize<Titansiege.CharactersData>, ISerialize
    {
        public void Write(Titansiege.CharactersData value, ISegment stream)
        {
        ...
        public Titansiege.CharactersData Read(ISegment stream) 
        {
		...
		public void Read(ref Titansiege.CharactersData value, ISegment stream)
		{
			var bits = stream.Read(5);
...
namespace Binding
{
	public readonly struct TitansiegeCharactersDataArrayBind : ISerialize<Titansiege.CharactersData[]>, ISerialize
	{
		public void Write(Titansiege.CharactersData[] value, ISegment stream)
		{
...
namespace Binding
{
	public readonly struct SystemCollectionsGenericListTitansiegeCharactersDataBind : ISerialize<System.Collections.Generic.List<Titansiege.CharactersData>>, ISerialize
	{
		public void Write(System.Collections.Generic.List<Titansiege.CharactersData> value, ISegment stream)
		{
		...
		public System.Collections.Generic.List<Titansiege.CharactersData> Read(ISegment stream)
		{
			var count = stream.ReadInt32();
			var value = new System.Collections.Generic.List<Titansiege.CharactersData>(count);
			if (count == 0) return value;
			var bind = new TitansiegeCharactersDataBind();
			for (int i = 0; i < count; i++)
		...
		public void WriteValue(object value, ISegment stream)
		{
			Write((System.Collections.Generic.List<Titansiege.CharactersData>)value, stream);
		}
